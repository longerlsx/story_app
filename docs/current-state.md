...
更新时间：2026-09-23。**当前任务是ZipVoice长听发热改善，15 Ultra已复现明显发烫，尚无优化通过结论。** 用户原反馈来自17 Pro、1.45×、亮屏、不充电，具体多久不确定；17 Pro暂不在场。15 Ultra问题包在同类条件20分钟内电池31.6→42.7°C，用户确认外壳明显发烫；主要CPU时间在原生推理库。1.45×有一次跨短段长静音，热态2×出现多次供给停顿；暂停／停止后未见持续失控计算。已冻结改善标准，首轮候选仅关闭原生等待自旋，保持四线程／四步，收益待测。条件、结果与限制由[发热改善计划](superpowers/plans/2026-09-23-offline-listening-thermal.md)维护；15 Ultra结果不能直接当作17 Pro验收。
