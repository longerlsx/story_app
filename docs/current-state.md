...
更新时间：2026-09-23。**当前任务是ZipVoice长听发热诊断，尚未确认根因或改善。** 用户实际反馈来自17 Pro、1.45×、亮屏、不充电，明显快速升温，具体时长不确定；17 Pro暂不在场。已连接15 Ultra的问题APK与9月22日交付包一致。短时正常播放／暂停／停止检查未见持续失控计算：暂停后CPU回落、停止释放服务；这些仅为定位证据，不证明长听温升通过。后续条件、基线、预先确定的改善标准及对照结果由[发热改善计划](superpowers/plans/2026-09-23-offline-listening-thermal.md)维护；15 Ultra结果不能直接当作17 Pro验收。
