...
| BUG-2026-040 | Page-mode immersive header overlaps the first body line; expanded back target also must stay outside text | resolved | `reader`, `page-mode`, `immersive-header`, `visual`, `interaction` | [BUG-2026-040-page-mode-immersive-header-overlaps-body.json](/Users/longshengxi/proj/story_app/docs/knowledge/bugs/BUG-2026-040-page-mode-immersive-header-overlaps-body.json) |
...
| BUG-2026-046 | TTS transformed-text offsets are applied directly to source text | resolved | `tts`, `offset`, `highlight` | [BUG-2026-046-tts-spoken-source-offset-mismatch.json](BUG-2026-046-tts-spoken-source-offset-mismatch.json) |
...
| BUG-2026-051 | A valid swipe is lost while the next chapter preview is unavailable | resolved | `page-mode`, `chapter-boundary`, `gesture` | [BUG-2026-051-unprepared-neighbor-swipe-not-accepted.json](BUG-2026-051-unprepared-neighbor-swipe-not-accepted.json) |
| BUG-2026-052 | Exiting during pending page navigation loses the selected reading mode | resolved | `settings`, `page-mode`, `scroll-mode`, `persistence` | [BUG-2026-052-pending-navigation-loses-selected-mode.json](BUG-2026-052-pending-navigation-loses-selected-mode.json) |
| BUG-2026-053 | Switching from PAGE to SCROLL briefly displays an old scroll viewport | resolved | `page-mode`, `scroll-mode`, `anchor-restore`, `visual` | [BUG-2026-053-page-to-scroll-shows-stale-viewport.json](BUG-2026-053-page-to-scroll-shows-stale-viewport.json) |
| BUG-2026-054 | Listening cannot resume after its playback service is destroyed | resolved | `tts`, `service`, `recovery` | [BUG-2026-054-listening-service-cannot-resume-after-destruction.json](BUG-2026-054-listening-service-cannot-resume-after-destruction.json) |
| BUG-2026-055 | Automatic listening location changes stop playback as manual navigation | resolved | `tts`, `navigation`, `page-mode` | [BUG-2026-055-listening-location-change-stops-playback.json](BUG-2026-055-listening-location-change-stops-playback.json) |
| BUG-2026-056 | A short chapter tail leaves the next chapter audio unprepared | resolved | `tts`, `offline`, `chapter-boundary` | [BUG-2026-056-short-chapter-tail-exhausts-audio-preparation.json](BUG-2026-056-short-chapter-tail-exhausts-audio-preparation.json) |
| BUG-2026-057 | Offline speech generation has insufficient sustained headroom on Xiaomi 15 Ultra | resolved | `tts`, `offline`, `performance`, `xiaomi` | [BUG-2026-057-offline-synthesis-insufficient-phone-headroom.json](BUG-2026-057-offline-synthesis-insufficient-phone-headroom.json) |
| BUG-2026-058 | Transient audio focus interruption discards audio and regenerates the current sentence | resolved | `tts`, `audio-focus`, `pause-resume` | [BUG-2026-058-transient-focus-regenerates-current-audio.json](BUG-2026-058-transient-focus-regenerates-current-audio.json) |
| BUG-2026-059 | Daytime bookshelf leaves light system-bar icons unreadable on a light background | resolved | `bookshelf`, `system-bars`, `day-night`, `visual` | [BUG-2026-059-bookshelf-system-bars-low-contrast.json](BUG-2026-059-bookshelf-system-bars-low-contrast.json) |
| BUG-2026-060 | ZipVoice native speed scaling truncates the generated target instead of producing normal double-speed speech | resolved | `tts`, `zipvoice`, `speech-rate`, `audio-integrity` | [BUG-2026-060-zipvoice-native-speed-truncates-target-audio.json](BUG-2026-060-zipvoice-native-speed-truncates-target-audio.json) |
| BUG-2026-061 | ZipVoice sends unnormalized Arabic numbers in Chinese narration to its English front end | resolved | `tts`, `zipvoice`, `text-normalization`, `chinese-numbers` | [BUG-2026-061-zipvoice-chinese-numbers-use-english-front-end.json](BUG-2026-061-zipvoice-chinese-numbers-use-english-front-end.json) |
| BUG-2026-062 | ZipVoice long listening heats Xiaomi phones and drains battery quickly | investigating | `tts`, `zipvoice`, `thermal`, `battery`, `performance` | [BUG-2026-062-zipvoice-long-listening-thermal.json](BUG-2026-062-zipvoice-long-listening-thermal.json) |
...
- If a valid swipe needs repeating when a neighbor preview is unavailable, start with `BUG-2026-051`; accepting navigation cannot depend on movement within an already prepared Pager window. `BUG-2026-049` covers the separate historical fling-completion timing issue.
- If a reading-mode choice disappears after exiting during a pending turn, start with `BUG-2026-052`; accepted settings must persist independently of the active display, while progress continues to use confirmed text.
- If PAGE-to-SCROLL ends at the correct text but briefly flashes an old chapter or heading, start with `BUG-2026-053`; feed readiness does not prove that the actual target line is ready to display. Inspect the transition, not only the final anchor.
...
- If a temporary TTS status/error message becomes too tall or covers too much text with long explanatory copy, start with `BUG-2026-044`; the confirmed fix is to constrain `ReaderTransientTtsMessage` text to one line with ellipsis and compare against a short single-line overlay.
